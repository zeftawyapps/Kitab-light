...
public class CategorySelectRecycleAdapter extends RecyclerView.Adapter<CategorySelectRecycleAdapter.MyViewHolder> {
    ...
    public CategorySelectRecycleAdapter(Context context, List<CategorySelectModelClass> offerList) {
        this.OfferList = offerList;
        this.context = context;
    }

    @Override
    public CategorySelectRecycleAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_category_select_list, parent, false);


        return new CategorySelectRecycleAdapter.MyViewHolder(itemView);
